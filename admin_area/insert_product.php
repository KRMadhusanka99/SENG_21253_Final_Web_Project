...
<?php
    ...
    if(isset($_POST['insert_product'])){
        ...
        //accessing images (temporary name,type,size,name)
        ...
        or $product_price=='' or $product_image1=='' or $product_image2==''){
            ...
            brand_id,product_image1,product_image2,product_price,date,status) values ('$product_title',
            '$description','$product_keywords','$product_category','$product_brands','$product_image1','$product_image2'
